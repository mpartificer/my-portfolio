...
const PortfolioData = {
  ...
  projects: [
    ...
    },
    {
      ...
      description: [
        "Tool for recipes that allows the user to use voice controls to dictate the pace at which a recipe is read to them",
      ],
      why: [
        "Too much butter and flour on my nice new laptop!",
        "My very first solo project in Javascript and I learned so much doing it!",
      ],
      technologies: [
        "Javascript",
        "HTML",
